...
const (
	RuntimeService_Version_FullMethodName = "/proto.RuntimeService/Version"
)
...
func (c *runtimeServiceClient) Version(ctx context.Context, in *VersionRequest, opts ...grpc.CallOption) (*VersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, RuntimeService_Version_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var RuntimeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.RuntimeService",
